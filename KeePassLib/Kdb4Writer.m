...
- (void)newFile:(NSString*)fileName withPassword:(KdbPassword*)kdbPassword withDBVersion:(DBVersion)dbVer {
    ...
    if(dbVer == DBVersionKdbx4) {
        ...
        tree.kdfParams = [KdbPassword getDefaultKDFParameters:[KdbUUID getArgon2UUID]];
