...
- (void)persist {
  ...
  [outputStream
      write:[document XMLDataWithOptions:DDXMLNodeCompactEmptyElement]];
}
...
- (DDXMLDocument *)persistTree {
  ...
  DDXMLDocument *document =
      [[DDXMLDocument alloc] initWithXMLString:@"<KeePassFile></KeePassFile>"
                                       options:0
                                         error:nil];
  ...
  [element
      addChild:[DDXMLNode elementWithName:@"DatabaseNameChanged"
                              stringValue:[self encodeDateTime:
                                                    tree.databaseNameChanged]]];
  [element addChild:[DDXMLNode elementWithName:@"DatabaseDescription"
                                   stringValue:tree.databaseDescription]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"DatabaseDescriptionChanged"
                       stringValue:[self encodeDateTime:
  ...
  [element
      addChild:[DDXMLNode
                   elementWithName:@"DefaultUserNameChanged"
                       stringValue:
                           [self encodeDateTime:tree.defaultUserNameChanged]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"MaintenanceHistoryDays"
                       stringValue:[NSString
                                       stringWithFormat:
                                           @"%ld",
                                           (long)tree.maintenanceHistoryDays]]];
  [element addChild:[DDXMLNode elementWithName:@"Color"
                                   stringValue:tree.color]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"MasterKeyChanged"
                       stringValue:[self
                                       encodeDateTime:tree.masterKeyChanged]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"MasterKeyChangeRec"
                       stringValue:[NSString
                                       stringWithFormat:
                                           @"%ld",
                                           (long)tree.masterKeyChangeRec]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"MasterKeyChangeForce"
                       stringValue:[NSString
                                       stringWithFormat:
                                           @"%ld",
                                           (long)tree.masterKeyChangeForce]]];

  DDXMLElement *protectionElement =
      [DDXMLElement elementWithName:@"MemoryProtection"];
  [protectionElement
      addChild:[DDXMLNode
                   elementWithName:@"ProtectTitle"
                       stringValue:tree.protectTitle ? @"True" : @"False"]];
  [protectionElement
      addChild:[DDXMLNode
                   elementWithName:@"ProtectUserName"
                       stringValue:tree.protectUserName ? @"True" : @"False"]];
  [protectionElement
      addChild:[DDXMLNode
                   elementWithName:@"ProtectPassword"
                       stringValue:tree.protectPassword ? @"True" : @"False"]];
  [protectionElement
      addChild:[DDXMLNode
                   elementWithName:@"ProtectURL"
                       stringValue:tree.protectUrl ? @"True" : @"False"]];
  [protectionElement
      addChild:[DDXMLNode
                   elementWithName:@"ProtectNotes"
                       stringValue:tree.protectNotes ? @"True" : @"False"]];
  [element addChild:protectionElement];

  if ([tree.customIcons count] > 0) {
    DDXMLElement *customIconsElements =
        [DDXMLElement elementWithName:@"CustomIcons"];
    for (KDB4CustomIcon *customIcon in tree.customIcons) {
  ...
  [element
      addChild:[DDXMLNode elementWithName:@"RecycleBinEnabled"
                              stringValue:tree.recycleBinEnabled ? @"True"
                                                                 : @"False"]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"RecycleBinUUID"
                       stringValue:[self persistUuid:tree.recycleBinUuid]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"RecycleBinChanged"
                       stringValue:[self
                                       encodeDateTime:tree.recycleBinChanged]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"EntryTemplatesGroup"
                       stringValue:[self
                                       persistUuid:tree.entryTemplatesGroup]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"EntryTemplatesGroupChanged"
                       stringValue:[self encodeDateTime:
                                             tree.entryTemplatesGroupChanged]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"HistoryMaxItems"
                       stringValue:[NSString
                                       stringWithFormat:@"%ld",
                                                        (long)tree
                                                            .historyMaxItems]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"HistoryMaxSize"
                       stringValue:[NSString
                                       stringWithFormat:@"%ld",
                                                        (long)tree
                                                            .historyMaxSize]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"LastSelectedGroup"
                       stringValue:[self persistUuid:tree.lastSelectedGroup]]];
  [element
      addChild:[DDXMLNode
                   elementWithName:@"LastTopVisibleGroup"
                       stringValue:[self
                                       persistUuid:tree.lastTopVisibleGroup]]];
  ...
  DDXMLElement *customDataElements =
      [DDXMLElement elementWithName:@"CustomData"];
  ...
  DDXMLElement *deletedObjectsElement =
      [DDXMLElement elementWithName:@"DeletedObjects"];
...
- (DDXMLElement *)persistCustomIcon:(KDB4CustomIcon *)customIcon {
  DDXMLElement *root = [DDXMLNode elementWithName:@"Icon"];

  [root
      addChild:[DDXMLNode elementWithName:@"UUID"
                              stringValue:[self persistUuid:customIcon.uuid]]];
  [root addChild:[DDXMLNode elementWithName:@"Data"
                                stringValue:customIcon.data]];
  return root;
}
...
- (DDXMLElement *)persistBinary:(Binary *)binary {
  ...
  [root addAttributeWithName:@"ID"
                 stringValue:[NSString stringWithFormat:@"%ld",
                                                        (long)binary.binaryId]];
  [root addAttributeWithName:@"Compressed"
                 stringValue:binary.compressed ? @"True" : @"False"];
...
- (DDXMLElement *)persistCustomItem:(CustomItem *)customItem {
  ...
  [root addChild:[DDXMLNode elementWithName:@"Key" stringValue:customItem.key]];
...
- (DDXMLElement *)persistGroup:(Kdb4Group *)group {
  ...
  [root addChild:[DDXMLNode elementWithName:@"Name" stringValue:group.name]];
  [root addChild:[DDXMLNode elementWithName:@"Notes" stringValue:group.notes]];
  [root addChild:[DDXMLNode
                     elementWithName:@"IconID"
                         stringValue:[NSString
                                         stringWithFormat:@"%ld",
                                                          (long)group.image]]];
  if (group.customIconUuid != nil) {
    [root
        addChild:[DDXMLNode
                     elementWithName:@"CustomIconUUID"
  ...
  [timesElement
      addChild:[DDXMLNode
                   elementWithName:@"LastModificationTime"
                       stringValue:
                           [self encodeDateTime:group.lastModificationTime]]];
  [timesElement
      addChild:[DDXMLNode
                   elementWithName:@"CreationTime"
                       stringValue:[self encodeDateTime:group.creationTime]]];
  [timesElement
      addChild:[DDXMLNode
                   elementWithName:@"LastAccessTime"
                       stringValue:[self encodeDateTime:group.lastAccessTime]]];
  [timesElement
      addChild:[DDXMLNode
                   elementWithName:@"ExpiryTime"
                       stringValue:[self encodeDateTime:group.expiryTime]]];
  [timesElement
      addChild:[DDXMLNode elementWithName:@"Expires"
                              stringValue:group.expires ? @"True" : @"False"]];
  [timesElement
      addChild:[DDXMLNode
                   elementWithName:@"UsageCount"
                       stringValue:[NSString
                                       stringWithFormat:@"%ld",
                                                        (long)
                                                            group.usageCount]]];
  [timesElement
      addChild:[DDXMLNode
                   elementWithName:@"LocationChanged"
                       stringValue:[self
                                       encodeDateTime:group.locationChanged]]];
  [root addChild:timesElement];

  // Add the additional properties
  [root addChild:[DDXMLNode
                     elementWithName:@"IsExpanded"
  ...
  [root
      addChild:[DDXMLNode
                   elementWithName:@"LastTopVisibleEntry"
                       stringValue:[self
                                       persistUuid:group.lastTopVisibleEntry]]];
...
- (DDXMLElement *)persistEntry:(Kdb4Entry *)entry
  ...
  [root addChild:[DDXMLNode elementWithName:@"Tags" stringValue:entry.tags]];
  ...
  [timesElement
      addChild:[DDXMLNode
                   elementWithName:@"LastModificationTime"
                       stringValue:
                           [self encodeDateTime:entry.lastModificationTime]]];
  [timesElement
      addChild:[DDXMLNode
                   elementWithName:@"CreationTime"
  ...
  [timesElement
      addChild:[DDXMLNode
                   elementWithName:@"LocationChanged"
                       stringValue:[self
                                       encodeDateTime:entry.locationChanged]]];
  [root addChild:timesElement];
...
- (DDXMLElement *)persistStringField:(StringField *)stringField {
  ...
  [root addChild:[DDXMLElement elementWithName:@"Key"
                                   stringValue:stringField.key]];
...
- (DDXMLElement *)persistBinaryRef:(BinaryRef *)binaryRef {
  ...
  [root addChild:[DDXMLElement elementWithName:@"Key"
                                   stringValue:binaryRef.key]];

  DDXMLElement *element = [DDXMLElement elementWithName:@"Value"];
  [element
      addAttributeWithName:@"Ref"
               stringValue:[NSString
                               stringWithFormat:@"%ld", (long)binaryRef.ref]];
  [root addChild:element];
...
- (DDXMLElement *)persistAutoType:(AutoType *)autoType {
  ...
  [root addChild:[DDXMLElement
                     elementWithName:@"Enabled"
                         stringValue:autoType.enabled ? @"True" : @"False"]];
  [root addChild:[DDXMLElement
                     elementWithName:@"DataTransferObfuscation"
                         stringValue:[NSString
                                         stringWithFormat:
                                             @"%ld",
                                             (long)autoType
  ...
  if (autoType.defaultSequence != nil) {
    [root addChild:[DDXMLElement elementWithName:@"DefaultSequence"
                                     stringValue:autoType.defaultSequence]];
  }
  ...
  for (Association *association in autoType.associations) {
    ...
    [element addChild:[DDXMLElement elementWithName:@"Window"
                                        stringValue:association.window]];
    [element
        addChild:[DDXMLElement elementWithName:@"KeystrokeSequence"
                                   stringValue:association.keystrokeSequence]];
...
- (DDXMLElement *)persistDeletedObject:(DeletedObject *)deletedObject {
  ...
  [element addChild:[DDXMLElement
                        elementWithName:@"UUID"
                            stringValue:[self persistUuid:deletedObject.uuid]]];
  [element
      addChild:[DDXMLElement
                   elementWithName:@"DeletionTime"
                       stringValue:[self encodeDateTime:deletedObject
                                                            .deletionTime]]];
...
- (void)encodeProtected:(DDXMLElement *)root {
  ...
  if ([[protectedAttribute stringValue] isEqual:@"True"]) {
    ...
    NSMutableData *mutableData =
        [[str dataUsingEncoding:NSUTF8StringEncoding] mutableCopy];
