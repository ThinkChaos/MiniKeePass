...
- (NSData *)serialize {
  ...
  for (NSString *key in dict) {
    ...
    if ([item isKindOfClass:[NSNumber class]]) {
      ...
      uint32_t num_type =
          (uint32_t)[(NSNumber *)type[key] unsignedIntegerValue];
      if (num_type == VARIANT_DICT_TYPE_UINT64) {
        ...
        [serData appendBytes:[key cStringUsingEncoding:NSASCIIStringEncoding]
                      length:keylen];
      ...
      [serData appendBytes:[str cStringUsingEncoding:NSASCIIStringEncoding]
                    length:[str length]];
      ...
      @throw [NSException exceptionWithName:@"Unknown Class Object"
