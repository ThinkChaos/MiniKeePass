...
- (void)parseMeta:(DDXMLElement *)root tree:(Kdb4Tree *)tree {
    ...
    // ADDING CUSTOM ICONS
//    [[ImageFactory sharedInstance] initializeWithCustomIcons:tree.customIcons];
...
//        NSString *representingCustomIcon = [customIconUuidElement stringValue];
...
//            NSString *stringtest = [[NSString alloc] initWithData:group.customIconUuid.getData encoding:NSASCIIStringEncoding];
//            if([representingCustomIcon compare:str] == NSOrderedSame)
//            {
//                [group.customIconUuid.getData isEqualToData:[[self parseUuidString:[customIconUuidElement stringValue]] getData]];
//                if([group.customIconUuid.getData isEqualToData:[[self parseUuidString:[customIconUuidElement stringValue]] getData]])
//                    NSLog(@"DATEN GLEICH");
//                
//                
//                NSLog(@"Treffer");
