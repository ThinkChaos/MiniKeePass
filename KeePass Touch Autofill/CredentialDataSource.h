...
/// Contains entries (and with KDB 4 Stringfields), including the current
/// filtering (searchbar e.g.)
@property(nonatomic, readonly) NSArray *likelyEntries;

/// Contains all not likely entries sorted after ABC, including the current
/// filtering  (searchbar e.g.)
