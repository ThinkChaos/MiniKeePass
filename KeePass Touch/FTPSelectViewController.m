...
- (id)init {
    ...
    if(self) {
        ...
        NSString *host = [KeychainUtils stringForKey:KPT_FTP_KEY_HOST andServiceName:KPT_FTP_SERVICE];
        NSString *user = [KeychainUtils stringForKey:KPT_FTP_KEY_USER andServiceName:KPT_FTP_SERVICE];
        NSString *pw = [KeychainUtils stringForKey:KPT_FTP_KEY_PASSWD andServiceName:KPT_FTP_SERVICE];
        
        self.client = [FTPClient clientWithHost:host port:21 username:user password:pw];
    }
    return self;
}
