...
- (id)init {
    ...
    if (self) {
        ...
        _helpTopics = @[
                         ...
                         [HelpTopic helpTopicWithTitle:@"Touch ID / Face ID" andResource:@"touchid"],
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.section == 0)
        ...
        cell.textLabel.text = NSLocalizedString(((HelpTopic *)_helpTopics[_helpTopics.count - 4 + indexPath.row]).title, nil);
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([[tableView cellForRowAtIndexPath:indexPath].textLabel.text containsString:@"Request"])
    {
        ...
        NSString *localizedResource = [NSString stringWithFormat:@"%@-%@", [language substringWithRange:NSMakeRange(0, 2)], resource];
