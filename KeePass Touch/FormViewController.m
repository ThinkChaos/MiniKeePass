...
- (id)init {
  ...
  if (self) {
    ...
    self.infoBar = [[InfoBar alloc]
        initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.frame), 20)];
...
- (CGRect)calculateNewFrameForView:(UIView *)view
                     inOrientation:(UIInterfaceOrientation)orientation {
  CGRect screenBounds = [[UIScreen mainScreen] bounds];
  CGFloat currentWidth = UIInterfaceOrientationIsPortrait(orientation)
