...
#define UrlFieldHeightForDevice(orientation) (UIDeviceOrientationIsPortrait(orientation) ? kUrlFieldPortHeight : kUrlFieldLandHeight)
#define UrlFieldHeightForInterface(orientation) (UIInterfaceOrientationIsPortrait(orientation) ? kUrlFieldPortHeight : kUrlFieldLandHeight)
...
- (void)viewDidLoad {
    ...
    CGFloat height = UrlFieldHeightForDevice([UIDevice currentDevice].orientation);
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error {
    ...
    UIAlertController *alertCon = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Title", nil) message:error.localizedDescription preferredStyle:UIAlertControllerStyleAlert];
