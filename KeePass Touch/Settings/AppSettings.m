...
- (NSInteger)defaultDatabase {
    return [userDefaults integerForKey:DEFAULT_DATABASE];
}
- (void)setDefaultDatabase:(NSInteger)database
{
    [userDefaults setInteger:database forKey:DEFAULT_DATABASE];
}
