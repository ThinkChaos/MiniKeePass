...
- (id)init {
    ...
    if (self) {
        ...
        versionSegmentedControl = [[UISegmentedControl alloc] initWithItems:[NSArray arrayWithObjects:NSLocalizedString(@"1.x", nil), NSLocalizedString(@"2.x", nil), @"KDBX 4", nil]];
