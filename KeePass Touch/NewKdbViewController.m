...
- (id)init {
  ...
  if (self) {
    ...
    self.footerTitle = NSLocalizedString(
        @"Do not forget your database password, it cannot be recovered.", nil);
    ...
    passwordTextField1.autocapitalizationType =
    ...
    passwordTextField2.placeholder =
        NSLocalizedString(@"Confirm Password", nil);
    passwordTextField2.secureTextEntry = YES;
    passwordTextField2.autocapitalizationType =
        UITextAutocapitalizationTypeNone;
    passwordTextField2.autocorrectionType = UITextAutocorrectionTypeNo;
    passwordTextField2.returnKeyType = UIReturnKeyDone;
    passwordTextField2.delegate = self;

    versionSegmentedControl = [[UISegmentedControl alloc]
        initWithItems:[NSArray arrayWithObjects:NSLocalizedString(@"1.x", nil),
                                                NSLocalizedString(@"2.x", nil),
                                                @"KDBX 4", nil]];
    ...
    self.controls = [NSArray arrayWithObjects:nameTextField, passwordTextField1,
                                              passwordTextField2, nil];
...
- (void)textFieldDidBeginEditing:(UITextField *)textField {
  ...
  UITableViewCell *cell = [self.tableView
      cellForRowAtIndexPath:[self.tableView indexPathForRowAtPoint:point]];
